      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '40px 24px 100px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <p style={{
            ...
            The visionary behind CheapRouter — on a mission to democratize AI access for every developer on the planet.
          </p>
        </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <div style={{
              ...
              <p style={{ color: 'var(--color-text-muted)', fontSize: '15px', lineHeight: 1.8, marginBottom: '16px' }}>
                Hasan is the founder and creator of CheapRouter — a unified AI API gateway that gives developers one key to access every major AI model in the world.
              </p>
              <p style={{ color: 'var(--color-text-muted)', fontSize: '15px', lineHeight: 1.8, marginBottom: '16px' }}>
                Driven by the belief that AI should be accessible, affordable, and simple to integrate, Hasan built CheapRouter from scratch to eliminate the complexity of managing multiple AI provider APIs.
              </p>
            ...
            <div style={{
              ...
              <p style={{ color: 'var(--color-text-muted)', fontSize: '15px', lineHeight: 1.8 }}>
                &ldquo;Every developer deserves access to the best AI models without drowning in complexity, cost, or vendor lock-in. CheapRouter exists to make that future a reality — one API key, infinite possibilities.&rdquo;
              </p>
            </div>
