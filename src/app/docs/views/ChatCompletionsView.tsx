          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div>
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', backgroundColor: 'var(--color-bg-muted)', padding: '8px 12px', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border)' }}>
                <span style={{ backgroundColor: 'var(--color-primary)', color: '#fff', padding: '2px 8px', borderRadius: 'var(--radius-md)', fontWeight: 800, fontSize: '11px' }}>POST</span>
                <code style={{ fontSize: '13px', fontWeight: 600, color: 'var(--color-text-main)' }}>{baseUrl}/v1/chat/completions</code>
              </div>
            </div>
