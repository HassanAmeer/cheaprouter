      ...
      <div>
        ...
        <div className="glass-card" style={{ padding: '24px', borderRadius: 'var(--radius-lg)', marginBottom: '32px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {/* URL */}
            <div>
              <span style={{ fontSize: '11px', fontWeight: 700, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.5px', display: 'block', marginBottom: '8px' }}>Endpoint URL</span>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', backgroundColor: 'var(--color-bg-muted)', padding: '8px 12px', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border)' }}>
                <span style={{ backgroundColor: 'var(--color-success)', color: '#fff', padding: '2px 8px', borderRadius: 'var(--radius-md)', fontWeight: 800, fontSize: '11px' }}>GET</span>
                <code style={{ fontSize: '13px', fontWeight: 600, color: 'var(--color-text-main)' }}>{baseUrl}/v1/models</code>
              </div>
            </div>
            ...
            {/* Authentication */}
            <div>
              <span style={{ fontSize: '11px', fontWeight: 700, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.5px', display: 'block', marginBottom: '8px' }}>Authentication</span>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: 'var(--color-success)', fontWeight: 600, fontSize: '13px' }}>
