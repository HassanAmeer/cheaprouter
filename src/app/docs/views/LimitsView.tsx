    ...
    >
      ...
      <div>
        <div style={{
          ...
          <h3 style={{ fontSize: '14px', fontWeight: 700, color: 'var(--color-primary)', marginBottom: '16px' }}>
            Error Handling
          </h3>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              <span style={{ backgroundColor: 'var(--color-primary)', color: '#fff', padding: '4px 8px', borderRadius: '4px', fontSize: '11px', fontWeight: 800, whiteSpace: 'nowrap' }}>
                429 Too Many Requests
              </span>
              <span style={{ fontSize: '13px', color: '#888', lineHeight: '1.6' }}>You have hit the rate limit.</span>
            </li>
            <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              <span style={{ backgroundColor: 'rgba(204, 0, 0, 0.1)', color: 'var(--color-primary)', padding: '4px 8px', borderRadius: '4px', fontSize: '11px', fontWeight: 800, whiteSpace: 'nowrap' }}>
