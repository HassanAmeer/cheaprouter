    ...
    >
      ...
      <div style={{ display: 'grid', gap: '20px', marginBottom: '40px' }}>
        <div style={{
          ...
          <h3 style={{ fontSize: '18px', fontWeight: 600, color: '#c9d1d9', marginBottom: '12px' }}>Rate Limits</h3>
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: '18px', fontWeight: 600, color: '#c9d1d9', marginBottom: '12px' }}>Token Quotas</h3>
          <p style={{ fontSize: '15px', color: '#8b949e', lineHeight: '1.6' }}>
      ...
      <div style={{
        ...
        <h3 style={{ fontSize: '18px', fontWeight: 600, color: '#ef4444', display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
            <span style={{ backgroundColor: 'rgba(239, 68, 68, 0.1)', color: '#ef4444', padding: '4px 8px', borderRadius: '4px', fontSize: '13px', fontWeight: 600, whiteSpace: 'nowrap' }}>
              429 Too Many Requests
            </span>
            <span style={{ fontSize: '15px', color: 'var(--color-text-muted)' }}>You have hit the rate limit (requests per minute). Slow down your requests.</span>
          </li>
          <li style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
            <span style={{ backgroundColor: 'rgba(234, 179, 8, 0.1)', color: '#eab308', padding: '4px 8px', borderRadius: '4px', fontSize: '13px', fontWeight: 600, whiteSpace: 'nowrap' }}>
              402 Payment Required
            </span>
            <span style={{ fontSize: '15px', color: 'var(--color-text-muted)' }}>Your account quota (tokens or hits) has been exhausted for the billing cycle.</span>
          </li>
        </ul>
      </div>
    </motion.div>
