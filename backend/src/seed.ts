...
async function seed() {
  ...
  if (existingAdminProvs.length > 0) {
    ...
    const adminProviders = [
      ...
      { id: 'ap_githubmodels', name: 'GitHub Models', status: true, key: 'ap_githubmodels-••••••••demo', priority: 15, base_url: '', api_format: 'openai', models: [{"id":"openai/gpt-4.1","name":"GPT-4.1"},{"id":"openai/gpt-4o","name":"GPT-4o"},{"id":"microsoft/phi-4","name":"Phi-4"},{"id":"meta/llama-3.3-70b-instruct","name":"Llama 3.3 70B Instruct"}] },
      { id: 'ap_opencode', name: 'OpenCode', status: true, key: 'ap_opencode-••••••••demo', priority: 11, base_url: 'https://opencode.ai/zen/v1', api_format: 'openai', models: [{"id":"deepseek-v4-flash-free","name":"DeepSeek V4 Flash Free"},{"id":"mimo-v2.5-free","name":"MiMo-V2.5 Free"},{"id":"laguna-s-2.1-free","name":"Laguna S 2.1 Free"},{"id":"ling-3.0-flash-free","name":"Ling-3.0-flash Free"},{"id":"north-mini-code-free","name":"North Mini Code Free"},{"id":"nemotron-3-ultra-free","name":"Nemotron 3 Ultra Free"},{"id":"big-pickle","name":"Big Pickle"}] },
