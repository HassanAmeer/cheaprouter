...
async function seed() {
  ...
  if (existingAdminProvs.length > 0) {
    ...
    const adminProviders = [
      { id: 'ap_openai', name: 'OpenAI',    status: true, key: 'sk-••••••••••••••••••••••••••••demo', priority: 1, base_url: 'https://api.openai.com/v1', api_format: 'openai', models: ['gpt-4o', 'gpt-4o-mini', 'gpt-4-turbo'] },
      ...
      { id: 'ap_meta', name: 'Meta',      status: false, key: 'meta-••••••••demo',                    priority: 4, base_url: 'https://api.meta.ai/v1',       api_format: 'openai', models: ['llama-3-70b', 'llama-3-8b'] },
      { id: 'ap_deepseek', name: 'DeepSeek', status: true, key: 'sk-••••deepseek-demo',                priority: 5, base_url: 'https://api.deepseek.com/v1', api_format: 'openai', models: ['deepseek-coder-v2', 'deepseek-chat'] },
    ];
